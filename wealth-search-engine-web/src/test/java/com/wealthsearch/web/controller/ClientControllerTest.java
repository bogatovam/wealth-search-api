...
class ClientControllerTest {
    ...
    void createClientWithValidData() throws Exception {
        ...
        mockMvc.perform(post("/clients")
                ...
                .andExpect(jsonPath("$.id").value(createdClient.getId().toString()))
    ...
    void createClientWithVariousValidCountryCodes() throws Exception {
        String[] countryCodes = {"US", "GB", "CH", "DE", "FR", "JP", "CN", "RU"};
    ...
    void createClientWithInvalidCountryCodeFormat() throws Exception {
        String[] invalidCodes = {"U", "USA", "us", "u1", "1A", "U$", ""};
    ...
    void createClientWithDuplicateEmail() throws Exception {
        ...
        when(clientService.createClient(any(Client.class)))
                .thenThrow(new DuplicateClientEmailException("duplicate@example.com"));

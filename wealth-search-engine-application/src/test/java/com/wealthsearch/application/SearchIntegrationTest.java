...
/**
 * Integration tests for search functionality. Tests the complete flow from HTTP
 * request through service layers to database.
 */
@SpringBootTest
...
class SearchIntegrationTest {
    ...
    void endToEndClientSearchFlow() throws Exception {
        ...
        mockMvc.perform(get("/search/clients").param("q", "neviswealth")
                                              .param("limit", "20")
                                              .param("offset", "0")
    ...
    void endToEndDocumentSearchFlowWithOllamaExpansion() throws Exception {
        ...
        mockMvc.perform(get("/search/documents").param("q", "wealth")
                                                .param("limit", "10")
                                                .param("offset", "0")
                                                .contentType(MediaType.APPLICATION_JSON))
    ...
    void clientSearchWithFuzzyMatching() throws Exception {
        ...
        mockMvc.perform(get("/search/clients").param("q", "neviswelth") // typo:
                                                                        // missing
                                                                        // 'a'
                                              .param("limit", "20")
                                              .param("offset", "0")
    ...
    void documentSearchWhenOllamaFails() throws Exception {
        ...
        mockMvc.perform(get("/search/documents").param("q", "wealth")
                                                ...
                                                .param("offset", "0")
                                                .contentType(MediaType.APPLICATION_JSON))
               // Then: Should still return results using original query as
               // fallback
               .andExpect(status().isOk())
    ...
    void searchReturnsEmptyWhenNoMatches() throws Exception {
        ...
        mockMvc.perform(get("/search/clients").param("q", "nonexistentdomain")
                                              .param("limit", "20")
                                              .param("offset", "0")
                                              .contentType(MediaType.APPLICATION_JSON))
    ...
    void searchValidatesQueryLength() throws Exception {
        ...
        mockMvc.perform(get("/search/clients").param("q", longQuery)
                                              .param("limit", "20")
                                              .param("offset", "0")
                                              .contentType(MediaType.APPLICATION_JSON))
    ...
    void searchValidatesLimit() throws Exception {
        ...
        mockMvc.perform(get("/search/clients").param("q", "test")
                                              .param("limit", "101")
                                              .param("offset", "0")
                                              .contentType(MediaType.APPLICATION_JSON))
               // Then: Should return 400 Bad Request
